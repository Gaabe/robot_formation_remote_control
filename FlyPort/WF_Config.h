...
/*--------------------------------------------*/
#define MY_DEFAULT_SSID_NAME                "LAC"

#define MY_DEFAULT_NETWORK_TYPE             WF_INFRASTRUCTURE   /* WF_INFRASTRUCTURE WF_SOFT_AP or WF_ADHOC     */

#define MY_DEFAULT_SCAN_TYPE                WF_PASSIVE_SCAN      /* WF_ACTIVE_SCAN or WF_PASSIVE_SCAN */

#define MY_DEFAULT_CHANNEL_LIST             {6}            /* use {} to scan all channels       */
...
#define MY_DEFAULT_WIFI_SECURITY_MODE        WF_SECURITY_WPA_WITH_PASS_PHRASE
...
#define MY_DEFAULT_PSK_PHRASE               "@lac2018"
...
//-----------------------------------------------------------------------------------
#define MY_DEFAULT_WEP_PHRASE           "passphrase"
